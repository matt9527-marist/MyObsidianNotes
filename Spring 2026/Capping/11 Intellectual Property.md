...
● Why this presentation?  
	– Guidelines for developers on what is required to  
	complete legal project deliverables  
	– Scoped to just what developers need to know for each  
	topic  
	– It is a business imperative to protect all assets with  
	appropriate licenses and protections, as well as  
	compliance with export and third party code obligations.  
● What this is not  
	– An alternative to seeking legal advice

**What is Intellectual Property?**
● This is a loosely-defined catch-all term for  
intangible things created by an author  
● This could be a book, a program, a business  
process, a slogan, a drawing, etc.  
● This differs from “real property”, which is a  
piece of land, and “personal property”, which  
are physical objects  
	– Real property ownership is conveyed via deed
...
expression which identifies products or services of  
a particular source from those of others.  
● This can be a word, phrase, picture, logo, or similar  
that is used to support a business purpose.  
● The primary purpose of a trademark is to allow  
customers to distinguish a product from a particular  
company from other, similar products

● If you see a word or phrase followed by the letters ™ or ®,  
that is an indication of a trademark.  
● The letters ™ indicate an unregistered trademark, which  
means that the owner claims exclusive use of the mark in  
question, but has not filed paperwork with the US Patent  
and Trademark Office to register it  
	– This may limit the owner’s ability to enforce ownership of the  
mark to a specific geographic region  
● The symbol ® indicates a registered trademark, which  
