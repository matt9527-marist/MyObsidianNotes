...
Let us assume that we bring in a set of individuals, let's say a mix of males or females. Initially, however, we know NOTHING about them. Suppose we take some measurements, and we end up with 3 separate categories. 
