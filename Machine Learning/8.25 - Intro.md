...
IF human intelligence is defined to the extent that humans' actions can be expected to achieve humans' objectives, AND machines are intelligent to the extent that their actions can be 